...
export const metadata: Metadata = {
  ...
  description: "Frankfurt 2027 Europa League Final guide: date, Stadion Frankfurt, where to stay and final-week travel planning.",
...
export default function FrankfurtPage() {
  return (
    <main className="content-page">
      ...
      <section className="city-competition-showcase city-competition-single" aria-label="Frankfurt 2027 competition">
        <Link className="competition-showcase-card" href="/finals/europa-league-final-frankfurt-2027">
          <div className="competition-logo-wrap">
            <img src="https://commons.wikimedia.org/wiki/Special:FilePath/UEFA%20Europa%20League%20logo%20%282024%20version%29.svg" alt="UEFA Europa League logo" loading="eager" />
          </div>
          <div>
            <span>26 MAY 2027</span>
            <h2>UEFA EUROPA LEAGUE</h2>
            <p>Final · Stadion Frankfurt · Germany</p>
          </div>
        </Link>
      </section>
