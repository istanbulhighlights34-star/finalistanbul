  ...
  return (
    <main className="content-page">
      <header className="page-header">
        ...
        <nav><Link href="/finals">Finals</Link><Link href="/cities/istanbul">Istanbul</Link><Link href="/cities/madrid" aria-current="page">Madrid</Link><Link href="/cities/frankfurt">Frankfurt</Link></nav>
