...
export default function Page() {
  return <TravelGuide
    ...
    note="This itinerary is a planning framework, not an event operations guide. Follow UEFA and local authorities for final-specific ticketing, gates, supporter zones and transport instructions when published."
  />;
}
