  ...
  return (
    <TravelGuide
      ...
      cards={[
        ...
        ["BEŞİKTAŞ / KABATAŞ", "Taksim connects to Kabataş via the F1 funicular. From the waterfront area, walking and local connections become relevant for Tüpraş Stadium."],
      ...
      relatedLinks={[
        ...
        { href: "/stadiums/chobani-stadium", label: "Chobani Stadium guide" },
      ]}
      sourceLinks={[
