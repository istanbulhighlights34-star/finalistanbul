...
export default function Page() {
  return <TravelGuide
    ...
    relatedLinks={[{href:"/finals/spanish-super-cup-istanbul-2027/barcelona-atletico-madrid",label:"Barcelona vs Atlético guide"},{href:"/finals/spanish-super-cup-istanbul-2027/real-sociedad-real-madrid",label:"Real Sociedad vs Real Madrid guide"},{href:"/finals/spanish-super-cup-istanbul-2027/final",label:"Super Cup Final guide"},{href:"/finals/spanish-super-cup-istanbul-2027",label:"Spanish Super Cup 2027"},{href:"/cities/istanbul/where-to-stay",label:"Where to stay in Istanbul"},{href:"/cities/istanbul/airports-and-transport",label:"Istanbul airports & transport"},{href:"/cities/istanbul",label:"Istanbul city hub"}]}
