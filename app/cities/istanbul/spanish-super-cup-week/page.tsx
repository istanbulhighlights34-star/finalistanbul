...
export default function Page() {
  return <TravelGuide
    ...
    note="Official ticketing, supporter zones, gates and event-specific transport arrangements are not assumed. Check RFEF and local authorities when those details are published."
  />;
}
