  ...
  return (
    <TravelGuide
      ...
      cards={[
        ...
        ["KADIKÖY", "The strongest base for the Chobani Stadium semi-final and Asian-side nightlife. Sabiha Gökçen Airport also connects to Kadıköy via the M4 metro corridor."],
      ]}
      relatedLinks={[
