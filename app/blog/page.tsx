...
export default function Blog() {
  return <main className={styles.shell}>
    <header className={styles.header}>
      ...
      <div className="blog-header-actions"><Link className="blog-header-journal" href="/blog" aria-current="page">Journal</Link><Link className={styles.cta} href="/finals">2027 Calendar</Link></div>
    </header>
