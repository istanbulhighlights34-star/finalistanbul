...
export const metadata: Metadata = { title: "Finals Travel Journal", description: "Evergreen travel planning for major football finals: matchday transport, where to stay and practical final-week strategy for Istanbul, Madrid and Frankfurt.", alternates: { canonical: "/blog" } };
...
export default function Blog() {
  return <main className={styles.shell}>
    <header className={styles.header}>
      ...
      <div className="blog-header-actions"><Link className="blog-header-journal" href="/blog" aria-current="page">Journal</Link><Link className="blog-header-arena" href="/arena">Arena</Link><Link className={styles.cta} href="/finals">2027 Calendar</Link></div>
    </header>
    ...
    <footer className={styles.footer}><div className={styles.brand}><img className={styles.brandMark} src="/icon.svg" alt="" aria-hidden="true" /><span className={styles.brandName}><span>FINALS</span><span>ATLAS</span></span></div><p>Independent editorial guide for supporters building a trip around the final.</p><p>© 2026 Finals Atlas</p></footer>
  </main>;
}
