...
export default function BlogArticle({article}:{article:Article}){
 ...
 return <main className={styles.shell}>
  ...
  <footer className={styles.footer}><div className={styles.brand}><span>FINALS</span><span>ATLAS</span></div><p>Independent editorial travel guide. Event-specific operations can change; verify final instructions with organizers and local transport authorities.</p><p>© 2026 Finals Atlas</p></footer>
 </main>
}
