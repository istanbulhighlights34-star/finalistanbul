...
export default function BlogArticle({article}:{article:Article}){
 ...
 return <main className={styles.shell}>
  ...
  <header className={styles.header}><Brand className={styles.brand} /><nav className={styles.nav}><Link href="/finals">Finals</Link><Link href="/cities/istanbul">Istanbul</Link><Link href="/cities/madrid">Madrid</Link><Link href="/cities/frankfurt">Frankfurt</Link></nav>
        ...
        </details><div className="blog-header-actions"><Link className="blog-header-journal" href="/blog" aria-current="page">Journal</Link><Link className="blog-header-journal" href="/arena">Arena</Link><Link className={styles.cta} href="/finals">Explore 2027</Link></div></header>
