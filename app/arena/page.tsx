...
export default function ArenaPage() {
  ...
  return <main className={styles.page}>
    ...
    <div className={styles.shell}>
      ...
      <section className={styles.intro}><div><p className={styles.kicker}>ROUND 01 · 24–25 SEPTEMBER</p><h1>Every sport<br /><em>counts.</em></h1></div><p className={styles.introText}>Choose the winners, a top-scoring team and your season picks. Match times adjust to your device.</p></section>
